...
let g:startify_commands = [
  \ {'s': "call g:StartDDUForFilerFullScreen(expand('/workspace_Scala'))"},
  \ {'p': "call g:StartDDUForFilerFullScreen(expand('/workspace_Python'))"},
  \ {'r': "call g:StartDDUForFilerFullScreen(expand('/workspace_Rust'))"}
  \]
